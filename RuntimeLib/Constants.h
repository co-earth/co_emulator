...
#define RUNTIME_ITEM_MASK_ACCOUNT_BINDING           (0b1 << 12)
#define RUNTIME_ITEM_MASK_CHARACTER_BINDING         (0b1 << 19)
#define RUNTIME_ITEM_MASK_TRADABLE_BINDING          (0b1 << 20)
#define RUNTIME_ITEM_MASK_BINDING                   RUNTIME_ITEM_MASK_ACCOUNT_BINDING | RUNTIME_ITEM_MASK_CHARACTER_BINDING | RUNTIME_ITEM_MASK_TRADABLE_BINDING
#define RUNTIME_ITEM_MASK_UPGRADE_LEVEL             (0b11111 << 13)
...
#define RUNTIME_UPGRADE_MAX_LEVEL_COUNT				            20
#define RUNTIME_UPGRADE_MAX_CORE_COUNT				            64
...
#define RUNTIME_MEMORY_MAX_MOB_DATA_COUNT			            4096
...
#define RUNTIME_MEMORY_MAX_WORLD_COUNT				            256
