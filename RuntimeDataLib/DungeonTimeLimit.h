...
RUNTIME_DATA_TYPE_BEGIN(DungeonGroup, "cabal.dungeon_group.group", 128)
...
RUNTIME_DATA_TYPE_BEGIN(DungeonTime, "cabal.dungeon_time.gruop_index", 16)
	RUNTIME_DATA_PROPERTY(Int32, Index, "index")
	RUNTIME_DATA_TYPE_BEGIN_CHILD(DungeonPlayTime, "dungeon_playtime", 8)
		RUNTIME_DATA_PROPERTY(Int32, DayOfWeek, "dayofweek")
		RUNTIME_DATA_PROPERTY(Int32, PlayTime, "play_time")
	RUNTIME_DATA_TYPE_END_CHILD(DungeonPlayTime, 8)
RUNTIME_DATA_TYPE_END(DungeonTime)
RUNTIME_DATA_TYPE_INDEX(DungeonTime, UInt32, Index)

RUNTIME_DATA_TYPE_BEGIN(DungeonCharge, "cabal.dungeon_charge.charge", 8)
	RUNTIME_DATA_PROPERTY(Int32, Index, "Index")
...
RUNTIME_DATA_TYPE_BEGIN(PlayTimeChargeFlag, "cabal.playtime_charge_flag.charge_flag", 8)
	RUNTIME_DATA_PROPERTY(Int32, Index, "Index")
